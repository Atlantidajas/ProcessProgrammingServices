...
public class ClienteFTP {
     ...
     *
     * @param rutaCompleta:
     * Ruta absoluta del fichero a subir, incluido el nombre del fichero,
     * por ejemplo, "D:\\\dir1\\file1.pdf"
     * @param nombreFichero:
     * Nombre del fichero, incluida su extension, con el que se guardara
     * en el servidor FTP
 ...
 *
 * @param directorio:
 * Directorio en el servidor FTP en el que nos queremos posicionar
...
public void cambiarDirectorio(String directorio) {
     ...
     *
     * @param fichero:
     * Fichero a borrar del directorio actual en el servidor FTP
     */
     ...
     *
     * @param directorio:
     * Directorio en el servidor FTP donde se encuentra el fichero a borrar
     * @param fichero:
     * Fichero a borrar en el servidor FTP
     */
